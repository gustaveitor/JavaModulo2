...
<nav role="navigation">
	...
	<div class="menudiv">
		<div class="menubar">
			...
			<label id="lbltweet" style="position:absolute;top:19em;right:.7em">Prestamos</label><div class="tweet menudesplegado" ><a href="../Comicstore/obtener_Prestamos"><img src="../Comicstore/imgs/money.png" ></a></div>
				</div>
	</div>
</nav>
<div class="cuerpo" >
<div class="galeria">
  <form action="/Comicstore/eliminar_Comics" method="post">
