...
<body>
	...
	<div class="cuerpo">
		<div class="galeria">
			<form class="" action="/Comiqueria/eliminar_Prestamos" method="post">
				<div class="contenedor-form">
					<div class="ftit renglones">
						<label class="form-tit">Eliminar Prestamo</label>
					</div>
					<div class="renglones">
						<div class="lab-cont">
						...
						<div class="">
							<select disabled id="personaselect" name="personaselect">
								<c:forEach var="personas" items="${pListado}">
									<c:choose>
										<c:when
											test="${personas.getIdPerson() != cloan.getPerson().getIdPerson()}">
											<option
												id="<c:out value="${personas.getIdPerson()}"></c:out>"
												value="<c:out value="${personas.getIdPerson()}">
             	</c:out>">
					...
					<div class="renglones">
						...
						<div class="">
							<select disabled id="comicselect" name="comicselect">
								<c:forEach var="comiques" items="${cListado}">
									<c:choose>
										<c:when
											test="${comiques.getIdComic() != cloan.getComic().getIdComic()}">
											<option id="<c:out value="${comiques.getIdComic()}"></c:out>"
												value="<c:out value="${comiques.getIdComic()}">
             	</c:out>">
										...
										<c:otherwise>
											<option selected
												id="<c:out value="${comiques.getIdComic()}"></c:out>"
												value="<c:out value="${comiques.getIdComic()}">
             	</c:out>">
												<c:out value="${comiques.getNameComic()}"></c:out>
											</option>
					...
					<div class="renglones">
						...
						<div class="">
							<input disabled type="date" id="hasta" name="hasta"
								class="form-cont" value="${cloan.getDate()}">
						</div>
