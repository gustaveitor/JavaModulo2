			...
			<div class="busqueda">
				<div class="buscar">
					<input type="text" id="search" name="txtBuqueda"
						placeholder="Ingrese busqueda..."> <a class="action"
						href="/Comiqueria/insertar_Prestamos"><button
								...
								<c:forEach var="i" begin="0" end="${Listado.size()-1}" step="1">
									<c:choose>
										<c:when test="${i mod 2 ne 0}">
											<tr class='alt'>
												<td><c:out
														value="${Listado.get(i).getComic().getNameComic()}"></c:out></td>
												<td><c:out
														value="${Listado.get(i).getPerson().getNamePerson()}"></c:out></td>
												<td><c:out value="${Listado.get(i).getDate()}"></c:out></td>
												<td>
													<div class="wwith">
														<a
															href="/Comiqueria/actualizar_Prestamos?id=${Listado.get(i).getIdLoan()}">
															<img src="/Comiqueria/imgs/editar.png">
														</a>
													</div>
													<div class="wwith">
														<a
															href="/Comiqueria/eliminar_Prestamos?id=${Listado.get(i).getIdLoan()}"><img
