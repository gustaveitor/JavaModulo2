  ...
  <form action="/Comicstore/eliminar_Personas" method="post">
    <div class="contenedor-form">
      ...
      <div class="renglones">
        ...
        <div class="">
          <input class="form-cont" disabled type="text" id="personname" name="personname" value ="<c:out value="${persona.getNamePerson()}"></c:out>" ></div>
        </div>
      <div class="renglones">
        <div class="lab-cont">
        ...
        <div class="">
          <input class="form-cont"  disabled type="text" id="persontel" name="persontel" value ="<c:out value="${persona.getTelephonePerson()}"></c:out>" >
        </div>
