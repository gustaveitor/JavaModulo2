...
<body>
	...
	<div class="cuerpo">
		<div class="galeria">
			<form class="" action="/Comiqueria/actualizar_Prestamos"
				method="post">
				<div class="contenedor-form">
					...
					<div class="renglones">
						...
						<div class="">
							<input tabindex=3 required type="date" id="hasta" name="hasta"
					...
					<div class="renglones">
						...
						<button tabindex=5 type="button" name="limpiar"
							onclick="windows.location.href='/Comiqueria/obtener_Prestamos'">Atras</button>
