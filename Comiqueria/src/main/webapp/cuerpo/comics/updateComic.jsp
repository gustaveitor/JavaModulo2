...
<body>
	...
	<div class="cuerpo">
		<div class="galeria">
			<form action="/Comiqueria/actualizar_Comics" name="comicForm"
				onsubmit="return validarComic();" method="post">
				<div class="contenedor-form">
					...
					<div class="renglones">
						...
						<div class="">
							<input class="form-cont" maxlength="45" type="text"
								id="comicname" name="comicname" tabindex=1
								value="<c:out value="${libro.getNameComic()}"></c:out>" />
						</div>
					</div>
					<div class="renglones">
						<div class="lab-cont">
						...
						<div class="">
							<input class="form-cont" maxlength="45" type="text" id="comicpub"
								name="comicpub" tabindex=2
								value=<c:out value="${libro.getCompanyComic()}"></c:out> />
						</div>
					...
					<div class="renglones">
						...
						<div class="">
							<input class="form-cont" min="0" max="11" type="number"
								id="comicstock" tabindex=3 name="comicstock"
								value="<c:out value="${Integer.parseInt(libro.getQuantityComic())}"></c:out>" />
						</div>
					...
					<div class="renglones">
						...
						<div class="">
							<textarea class="form-cont" maxlength="500" id="comicreview"
								tabindex=4 name="comicreview"> <c:out
									value="${libro.getReviewComic()}"></c:out></textarea>
						</div>
					...
					<div class="renglones">
						...
						<button type="button" tabindex=6 name="limpiar"
