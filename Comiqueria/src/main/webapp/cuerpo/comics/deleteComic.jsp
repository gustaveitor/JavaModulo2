			...
			<form action="/Comiqueria/eliminar_Comics" method="post">
				<div class="contenedor-form">
					...
					<div class="renglones">
						...
						<div class="">
							<input class="form-cont disable" disabled type="text"
					...
					<div class="renglones">
						...
						<div class="">
							<input class="form-cont" type="text" disabled
					...
					<div class="renglones">
						...
						<div class="">
							<input class="form-cont" type="number" disabled
					...
					<div class="renglones">
						...
						<div class="">
							<textarea class="form-cont" disabled> <c:out
					...
					<div class="renglones">
						...
						<button type="button" name="guardar"
