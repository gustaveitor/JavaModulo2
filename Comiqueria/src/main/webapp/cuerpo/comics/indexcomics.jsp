		...
		<div class="galeria">
			<div class="busqueda">
				<div class="buscar">
					...
					<c:if test="${rol ne null}">
						<c:if test="${rol[0] eq 'admin'}">
							<a class="action" href="/Comiqueria/insertar_Comics"><button
									...
									<c:choose>
										<c:when test="${i mod 2 ne 0}">
											<tr class='alt'>
												...
												<td><c:if test="${rol ne null}">
														<c:if test="${rol[0] eq 'admin'}">
															<div class="wwith">
																<a
																	href="/Comiqueria/actualizar_Comics?id=${Listado.get(i).getIdComic()}">
															...
															<c:if test="${Listado.get(i).getDeletable() eq false }">
																<div class="wwith">
																	<a
																		href="/Comiqueria/eliminar_Comics?id=${Listado.get(i).getIdComic()}"><img
